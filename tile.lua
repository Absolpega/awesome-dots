...
local function apply_size_hints(c, width, height, useless_gap)
    ...
    width = width - 2 * bw - useless_gap
    height = height - 2 * bw - useless_gap
    width, height = c:apply_size_hints(math.max(1, width), math.max(1, height))
    return  width   + 2 * bw + useless_gap,
            height  + 2 * bw + useless_gap
end

--local function apply_size_hints(c, width, height, useless_gap)
--    local bw = c.border_width
--    width = width   - 2 * bw - beautiful.useless_gap_width
--    height = height - 2 * bw - beautiful.useless_gap_height
--    width, height = c:apply_size_hints(math.max(1, width), math.max(1, height))
--    return  width   + 2 * bw + beautiful.useless_gap_width ,
--            height  + 2 * bw + beautiful.useless_gap_height
--end
